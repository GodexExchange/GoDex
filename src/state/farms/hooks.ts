...
export const usePriceBnbBusd = (): BigNumber => {
  ...
  if(chainId === "97")
    return farm.tokenPriceVsQuote ? new BigNumber(1).dividedBy(new BigNumber(farm.tokenPriceVsQuote)) : ZERO
...
export const usePriceCakeBusd = (): BigNumber => {
  ...
  const farm = useFarmFromPid(pid)
  // console.log('farm.tokenPriceVsQuote',farm.tokenPriceVsQuote.toNumber(), bnbPriceUSD.toNumber())
